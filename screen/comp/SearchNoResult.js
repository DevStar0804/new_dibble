    ...
    render() {
        ...
        return (
            <ScrollView style={{flexDirection: 'column', width:screenWidth, flex:1}}>
                <View style={{flexDirection:"column", alignItems:"center", marginTop:screenHeight*0.05,marginBottom:screenHeight*0.05}}>
                    <Image
                    ...
                    <Text style={[globalStyle.textBasicStyle, mStyle.textMessage]}>{langObj.searchNoResult}</Text>
                </View>
